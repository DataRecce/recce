...
/**
 * Run type - will be expanded with specific param/result types as API files are migrated.
 * For now, use unknown for params/result to allow gradual migration.
 *
 * The full discriminated union (with QueryResult, ValueDiffResult, etc.) will be
 * built incrementally in Phase 3 as individual API files are migrated.
 */
