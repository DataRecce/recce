...
describe("renderTypeCell", () => {
  describe("type changed scenarios", () => {
    ...
    test("renders badges with aria-label for accessibility", () => {
      const props = createTypeCellProps({
        baseIndex: 1,
        currentIndex: 1,
        baseType: "INTEGER",
      ...
      const integerBadge = screen.getByLabelText("Base type: INTEGER");
      const bigintBadge = screen.getByLabelText("Current type: BIGINT");
