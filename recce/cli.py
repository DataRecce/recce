...
def mcp_server(state_file, sse, host, port, **kwargs):
    ...
    \b
    Available tools:
      In server mode (full access, 16 tools):
        Metadata & navigation:
        ...
        Data diff (requires warehouse connection):
      ...
      In preview/read-only modes (non-server):
        Only the 6 metadata & navigation tools above are available.
        Data diff and check management tools are disabled.
