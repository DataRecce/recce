...
class OnboardingStateTest(unittest.TestCase):
    ...
    @patch("recce.util.onboarding_state.get_recce_cloud_onboarding_state", return_value="new")
    ...
    @patch("recce.util.onboarding_state.set_recce_cloud_onboarding_state")
    @patch("recce.util.onboarding_state.get_recce_cloud_onboarding_state", return_value="launched")
    ...
    @patch("recce.util.onboarding_state.set_recce_cloud_onboarding_state")
    @patch("recce.util.onboarding_state.get_recce_cloud_onboarding_state", return_value="launched_with_two_envs")
